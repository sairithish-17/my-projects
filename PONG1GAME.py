...
def ball_working():
    ...
    if ball.colliderect(player2):
        ball_sign_x*=-1
    ball_change_x=9*ball_sign_x
    ball_change_y=9*ball_sign_y
...
while True:
    while game_close == True:
            for y in range(1,400):
                ...
                print(' ')
            dis.fill(blue)
            message1("Press C-Play Again or Q-Quit", black,100,300)
            if w=='p1':
                message("player 1 won",black,300,200)
            elif w=='p2':
                message("player 2 won",black,300,200)
            pygame.display.update()
    ...
    if p1==5:
        ...
        game_close=True
        # dis.fill(black)
        # message('P1 WON',blue,300,200)
        # message1('Q-QUIT P-PLAYAGAIN',blue,100,300)
        # pygame.display.update()
        # for event in pygame.event.get():
        #     if event.type==pygame.KEYDOWN:
        #         if event.key==pygame.K_q:
